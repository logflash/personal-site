<TransitionHeading
  transition="resume-title"
  returnTo="/$locale"
  returnLabel="Home"
  translatedLabel="Resume"
/>
...
<MdxSection id="education" coupleDisclosureActions="wrapped">
...
<MdxSection id="experience" coupleDisclosureActions="auto">
